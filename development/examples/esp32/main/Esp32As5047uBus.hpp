 ...
 * @brief ESP32 SPI transport implementation for AS5047U driver
 * 
 * This class implements the AS5047U::spiBus interface using ESP-IDF's SPI driver.
 * It supports configurable SPI pins, frequency, and chip select.
 */
class Esp32As5047uBus : public AS5047U::spiBus {
public:
    /**
